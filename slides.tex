...
\begin{frame}[fragile]{Reifying dependently typed operators}
  ...
  Our reification templete program returns \emph{TemplateMonad
    reifyResult}. The reification of function composition is
  implemented as:
...
\begin{frame}{Stats}
  Conclude, with an assessment of the LOCs needed to develop this
  step, how much time it took to develop, how much actual time the
  reification/proofs of semantic correctness take on reasonable
  examples.
\end{frame}
